...
register_with_new_api() {
    local na_port="$1"
    local channel_name="" model_alias=""

    case "$SERVER_ROLE" in
        embedding)  channel_name="Local Embedding Server"; model_alias="$MODEL_NAME" ;;
        reranking)  channel_name="Local Reranker Server";  model_alias="$MODEL_NAME" ;;
